    ...
    <nav className="movie-nav movie-card__nav">
      <ul className="movie-nav__list">
        <li className={`movie-nav__item ${activeTab === `overview` ? `movie-nav__item--active` : ``}`}>
          <a href="#" className="movie-nav__link" onClick={(evt) => onTabClick(evt, `overview`)}>Overview</a>
        </li>
        <li className={`movie-nav__item ${activeTab === `details` ? `movie-nav__item--active` : ``}`}>
          <a href="#" className="movie-nav__link" onClick={(evt) => onTabClick(evt, `details`)}>Details</a>
        </li>
        <li className={`movie-nav__item ${activeTab === `reviews` ? `movie-nav__item--active` : ``}`}>
          <a href="#" className="movie-nav__link" onClick={(evt) => onTabClick(evt, `reviews`)}>Reviews</a>
        </li>
      </ul>
    </nav>
