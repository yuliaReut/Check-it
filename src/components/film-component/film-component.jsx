        ...
        <div className="movie-card__wrap">
          <div className="movie-card__desc">
            ...
            <div className="movie-card__buttons">
              ...
              {status === AuthorizationStatus.AUTH && user !== null ? <Link to ={`/films/${id}/review`} className="btn movie-card__button">Add review</Link> : ``}
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="page-content">
      <section className="catalog catalog--like-this">
        ...
        <div className="catalog__movies-list">
          <FilmsList films={allFilms.filter((filmCard) => filmCard.genre === item.genre).slice(0, 4)} maxFilms={currentNumberFilms}></FilmsList>
        </div>
      </section>
